...
export default function Clubs() {
  ...
  const [editModal, setEditModal] = useState<{
    isOpen: boolean;
    clubIndex: number | null;
    formData: { prefix: string; status: AttendanceStatus };
  }>({
    isOpen: false,
    clubIndex: null,
  ...
  const handleEditConfirm = () => {
    if (editModal.clubIndex !== null) {
      ...
      updatedClubs[editModal.clubIndex] = {
        ...updatedClubs[editModal.clubIndex],
        prefix: editModal.formData.prefix,
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter club prefix (e.g., ABC, XYZ)"
                  />
                </div>
        ...
        <div className="fixed inset-0 bg-black/25 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleEditConfirm(); }} className="space-y-4">
              <div>
                <label htmlFor="edit-prefix" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Club Prefix
                </label>
                <input
                  type="text"
                  id="edit-prefix"
                  name="prefix"
                  value={editModal.formData.prefix}
                  onChange={handleEditInputChange}
                  required
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white sm:text-sm"
                  placeholder="Enter club prefix"
                />
              </div>
